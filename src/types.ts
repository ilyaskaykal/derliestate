...
export interface Musteri {
  ...
  takas_acik?: boolean;
  lead_skoru?: number | null;
  musteri_ozeti?: string | null;
  takip_zamanlamasi?: Record<string, string> | null;
}
...
export interface Portfoy {
  ...
  pafta?: string;
  eids_status?: string;
  eids_son_tarih?: string;
  sahibi_ad?: string;
  sahibi_telefon?: string;
  sahibi_tc?: string;
...
export type PortfoyTip = 'daire' | 'villa' | 'arsa' | 'ticari' | 'yazlik' | 'mustakil' | 'rezidans' | 'bina' | 'ofis';
export type PortfoyDurum = 'aktif' | 'pasif' | 'satildi' | 'kiralik' | 'kiralandi' | 'opsiyon';
